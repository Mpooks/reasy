...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String q18= "CREATE TABLE reception(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, c_id INT NOT NULL,guests INT NOT NULL, dateR VARCHAR(255) NOT NULL, a_id INT, rad INT NOT NULL, cid INT, FOREIGN KEY(c_id) REFERENCES customer(id),FOREIGN KEY(a_id) REFERENCES artist(id),FOREIGN KEY(rad) REFERENCES reception_area(id),FOREIGN KEY(cid) REFERENCES catering(id))";
        ...
        String q27= "CREATE TABLE invitation(rid INT NOT NULL, cid INT NOT NULL, dateR VARCHAR(255) NOT NULL, descr VARCHAR(255), PRIMARY KEY(rid,cid),  FOREIGN KEY(rid) REFERENCES reception(id), FOREIGN KEY(cid) REFERENCES customer(id))";
        ...
        String i8= "INSERT INTO s_table VALUES(1,3,2),(2,2,1),(3,2,1),(4,1,2),(5,2,2),(6,3,4),(7,8,3);";
        ...
        String i17= "INSERT INTO reservation VALUES(1,1,5,2,\"2023-05-22\",\"20:30\",2,null,null),(2,2,5,1,\"2023-05-19\",\"21:30\",4,null,null),(3,1,5,2,\"2023-05-01\",\"20:30\",3,null,null),(4,3,6,2,\"2023-05-21\",\"22:30\",1,null,null),(5,4,7,3,\"2023-05-01\",\"19:30\",6,null,null)";
        ...
        String i20= "INSERT INTO n_t VALUES(1,4),(4,1),(2,3),(3,2)";
        ...
        String i23= "INSERT INTO rating VALUES(1,2,5,4.3)";
